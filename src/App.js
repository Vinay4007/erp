...
import Payments3 from "./Component/Payments3";
import Compr from "./Component/Compr";
import CHECKSTAT from "./Component/checkstaths";
import CHECKSTAT1 from "./Component/checkstat1";
...
import QrA from "./Component/QrA";
import QrH from "./Component/QrH";
    ...
    <div className="print">
      <div className="bckground">
        <Router>
          ...
          <Route path="/pay3" component={Payments3} />
          <Route path="/chs" component={CHECKSTAT} />
          <Route path="/chs1" component={CHECKSTAT1} />
          ...
          <Route path="/qra" component={QrA} />
          <Route path="/qrh" component={QrH} />
          <Route path="/qrm" component={QrM} />

          <Route path="/stud" component={Studentadmin} />
