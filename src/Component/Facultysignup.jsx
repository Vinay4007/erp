        ...
        <>
          <section className="signup1">
            ...
            <div classname="container mt-5">
             ...
             <div classname="signup1-form">
                ...
                <div className="form-group form-button">
                        <input type="submit" name="signup1" id="signup1" className="form-submit"
            ...
            <div class="col">
                ...
                <h6>IF ALREADY REGISTERED  <a class="btn btn-primary" href="/login1" role="button">Login Here</a></h6>
                <br/>
            </div>
            </div>
          </section>
