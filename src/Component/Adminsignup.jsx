        ...
        <>
          <section className="signup2">
            ...
            <div classname="container mt-5">
             ...
             <div classname="signup2-form">
                ...
                <div className="form-group form-button">
                        <input type="submit" name="signup2" id="signup2" className="form-submit"
            ...
            <div class="col">
                ...
                <h6>IF ALREADY REGISTERED  <a class="btn btn-primary" href="/login2" role="button">Login Here</a></h6>
                <br/>
            </div>
            </div>
          </section>
